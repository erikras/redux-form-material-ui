...
describe('TimePicker', () => {
  it('has a display name', () => {
    expect(ReduxFormMaterialUITimePicker.displayName).toBe('ReduxFormMaterialUITimePicker')
  })
  ...
  it('renders a TimePicker with no value', () => {
    expect(new ReduxFormMaterialUITimePicker({
      ...
      .toEqualJSX(<TimePicker name="myTimePicker" onChange={noop} ref="component"/>)
  })
  ...
  it('renders a TimePicker with a value', () => {
    ...
    expect(new ReduxFormMaterialUITimePicker({
      ...
      .toEqualJSX(<TimePicker name="myTimePicker" onChange={noop} value={value} ref="component"/>)
  })
  ...
  it('renders a TimePicker with an error', () => {
    ...
    expect(new ReduxFormMaterialUITimePicker({
      ...
      .toEqualJSX(<TimePicker name="myTimePicker" value={value} errorText="FooError" onChange={noop}
        ref="component"/>)
  })
  ...
  it('maps onChange properly', () => {
    ...
    const dom = TestUtils.renderIntoDocument(
      <MuiThemeProvider muiTheme={getMuiTheme()}>
        <ReduxFormMaterialUITimePicker input={{ name: 'myTimePicker', onChange, value: first }}/>
      </MuiThemeProvider>
    )
  ...
  it('provides getRenderedComponent', () => {
    const dom = TestUtils.renderIntoDocument(
      <MuiThemeProvider muiTheme={getMuiTheme()}>
        <ReduxFormMaterialUITimePicker input={{ name: 'myTimePicker', onChange: noop }}/>
      </MuiThemeProvider>
    )

    const element = TestUtils.findRenderedComponentWithType(dom, ReduxFormMaterialUITimePicker)
